...
static const uint8_t CRED_R[95] = { 
...
static CredentialC cred_i = {0}, fetched_cred_r = {0}, expected_cred_r = {0};
...
int main(void) {
    ...
    while (1) {
        ...
        if (edhoc_state ==0) {
            ...
            prepare_mutual_ead_1(&ead_1, 3, true);
            printf("ead 1 is\n");
            for(uint8_t i = 0; i < ead_1.value.len; i++) {
                printf("%02x", ead_1.value.content[i]);
            }
            printf("\n");
            ...
            printf("message 1 len = %u, content:", message_1.len);
            for(uint8_t i = 0; i < message_1.len; i++) {
                printf("%02x", message_1.content[i]);
            }
            printf("\n");
            ...
            if (session_msg_2 == 0){
                ...
                *ptr = c_r;
                ...
                printf("message 4 len is %d, and the content is\n", message_4.len);
                for (uint8_t i = 0; i< message_4.len; i++) {
